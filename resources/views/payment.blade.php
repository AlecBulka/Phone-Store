        ...
        <form action="{{ route('order') }}" method="post">
            ...
            <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                ...
                <div class="">
                    ...
                    <div class="relative">
                        <input required type="text" id="card-holder" name="card-holder"
                    ...
                    <div class="flex">
                        <div class="relative w-7/12 flex-shrink-0">
                            <input required type="number" id="card-no" name="card-no"
                        ...
                        <input required type="text" name="credit-expiry"
                            class="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                            placeholder="MM/YY" />
                        <input required type="number" name="credit-cvc"
                    ...
                    <div class="flex flex-col sm:flex-row">
                        <div class="relative flex-shrink-0 sm:w-7/12">
                            <input required type="text" id="billing-address" name="billing-address"
                                class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Street Address" />
                            <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                <img class="h-4 w-4 object-contain" src="{{ asset('img/flag.svg') }}" alt="" />
                            </div>
                        </div>
                        <input required type="text" id="billing-address" name="billing-address"
                            class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                            placeholder="City" />
                        <input required type="number" name="billing-zip"
                    ...
                    <div class="mt-6 border-t border-b py-2">
                        <div class="flex items-center justify-between">
                            ...
                            <p class="font-semibold text-gray-900">{{ number_format(Cart::getTotal(), 2) }} €</p>
                        </div>
                    </div>
                    <div class="mt-6 flex items-center justify-between">
                        <p class="text-sm font-medium text-gray-900">Total</p>
                        <p class="text-2xl font-semibold text-gray-900">{{ number_format(Cart::getTotal(), 2) }} €</p>
                    </div>
                </div>
                <input type="hidden" value="{{$products}}" name="products">
                <input type="hidden" value="{{$quantities}}" name="quantities">
                <input type="hidden" value="{{Cart::getTotal()}}" name="totalCost">

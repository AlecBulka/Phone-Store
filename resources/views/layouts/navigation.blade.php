            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->role_id == 2)
                        <x-nav-link :href="route('admin-view-products')" :active="request()->routeIs('admin-view-products')">
                            {{ __('View Products') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin-create-product')" :active="request()->routeIs('admin-create-product')">
                            {{ __('Create Product') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin-view-users')" :active="request()->routeIs('admin-view-users')">
                            {{ __('View Users') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin-create-user')" :active="request()->routeIs('admin-create-user')">
                            {{ __('Create User') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin-view-orders')" :active="request()->routeIs('admin-view-orders')">
                            {{ __('View Orders') }}
                        </x-nav-link>
                    @endif
                </div>

                ...
                <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
                    ...
                    <div class="flex-1">
                                ...
                                @foreach ($cartItems as $item)
                                    <tr>
                                        <td class="hidden pb-4 md:table-cell" style="width:230px;">
                                            <a href="#">
                                                <img src="{{$item->attributes->image}}" class="w-[200px] h-[100px] object-contain rounded" alt="Thumbnail">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="#">
                        ...
                        <div class="flex justify-between items-center my-5">
                            <div class="font-semibold text-2xl">Total: {{ number_format(Cart::getTotal(), 2) }} €</div>
                            <div>
                                <a class="px-6 py-2 rounded shadow text-white bg-gray-800" href="{{route('payment')}}">Pay</a>
                            </div>
                        </div>
